...
# curl https://raw.githubusercontent.com/Navid200/cgm-remote-monitor/ub24_Test8Clean/bootstrap.sh | bash
...
sudo git checkout ub24_Test8Clean  # ⛔⛔⛔⛔⛔ For test - Comment out before PR.
